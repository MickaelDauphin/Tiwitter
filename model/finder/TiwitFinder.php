...
class TiwitFinder implements FinderInterface
{
    ...
    public function findAll(){
        $query = $this->conn->prepare('SELECT t.id, t.utilisateur, t.contenu FROM tiwit t ORDER BY t.id DESC'); // Création de la requête + utilisation order by pour ne pas utiliser sort
